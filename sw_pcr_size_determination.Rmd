...
<img style="float: right;" width=300 src="img/gel-electrophoresis-tutorial/gel_raw.png">
...
<img style="float: right;" width=300 src="img/gel-electrophoresis-tutorial/gel_inverted_rotated.png">
...
<img style="float: right;" width=300 src="img/gel-electrophoresis-tutorial/gel_cropped.png">
...
<img style="float: right;" width=300 src="img/gel-electrophoresis-tutorial/gel_mapped.png">
...
<img style="float: right;" width=300 src="img/gel-electrophoresis-tutorial/density_peaks.png">
When all peaks are marked press Ctrl + M. A new window should appear with x and y measurements (Figure 6).
<img style="float: right;" width=300 src="img/gel-electrophoresis-tutorial/results.png">
