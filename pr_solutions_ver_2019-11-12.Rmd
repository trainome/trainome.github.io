...
**Note:** The Kopec buffer is suitable for dissolvining the protein pellet after Trizol extraction. See full protocol: [Extraction of RNA and protein from muscle samples using Trizol reagent](pr_trizol_ver_20191111.html).
